...
- **Auto-reject offers** automatically dismisses incoming AI diplomacy offers. AI realms also avoid accepting or sending diplomacy when they have no legal neighboring attack available.
...
- The former Dark frontier style is now **Relaxing ambient**, using higher, softer tones without heavy bass. All styles except Campaign now avoid low bass frequencies.
- **War march** now has an original Mehter-inspired ceremonial drum rhythm and bright marching melody.
