...
function playCampaignBar() {
  ...
  const styles={campaign:{roots:[73.42,65.41,58.27,65.41],step:.48,type:'sine'},tension:{roots:[55,58.27,61.74,55],step:.25,type:'sawtooth'},march:{roots:[65.41,73.42,82.41,65.41],step:.36,type:'square'},shadow:{roots:[130.81,146.83,164.81,146.83],step:.82,type:'sine'},calm:{roots:[87.31,98,110,98],step:.7,type:'sine'}}
